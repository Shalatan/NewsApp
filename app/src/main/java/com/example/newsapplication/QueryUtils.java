...
public class QueryUtils {
    ...
    public static ArrayList<News> fetchNewsDataFromJson(String newsJson) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                News news = new News(title, webUrl, sectionName, date, time, author);
                arrayList.add(news);
            }
    ...
    public static List<News> fetchNewsData(String requestUrl) {
        ...
        List<News> newsData = fetchNewsDataFromJson(jsonResponse);
        return newsData;
    }
